 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://wsdl2java}incident" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProcessRequestResponse {
    ...
    protected List<Incident> _return;
     ...
     * 
     */
    public List<Incident> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Incident>();
        }
        return this._return;
    }
